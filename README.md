...
Projeto para a implementação de testes e funções utilizando uma abordagem de desenvolvimento orientado a testes desenvolvido durante o curso de desenvolvimento de software na [Trybe](https://www.betrybe.com/).
